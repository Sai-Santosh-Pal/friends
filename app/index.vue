<template>
  <div  class="overflow-x-hidden">
    ...
    <div class="h-[100vh] w-[100vw] flex items-center flex-col justify-center bg-white">
      ...
      <div class="flex mt-5 gap-5 items-center">
        <Buttons text="Coming Soon"/>
        <p class="text-black text-[14px]">Learn More</p>
      </div>
    </div>
    <div class="h-[100vh] w-[100vw] bg-black text-white flex items-center flex-col justify-center">
